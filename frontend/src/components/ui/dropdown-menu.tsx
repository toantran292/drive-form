...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                "z-50 min-w-[12rem] overflow-hidden rounded-md border bg-white p-1 text-black shadow-md animate-in fade-in-0 zoom-in-95 dark:bg-neutral-900 dark:text-white",
                className
            )}
            {...props}
        />
