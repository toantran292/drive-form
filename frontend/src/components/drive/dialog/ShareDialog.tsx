    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle>Chia sẻ &quot;{fileName}&quot;</DialogTitle>
                </DialogHeader>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex items-center mb-4">
                                    ...
                                    <span className="ml-3 text-sm text-gray-600">
                                        {shareIsPublic ? 'Bất kì ai có đường liên kết' : 'Chỉ 1 số người có đường liên kết'}
                                    </span>
                                </div>
                            </div>
                ...
                <DialogFooter>
                    <button
                        ...
                        title={shareCopied ? 'Đã sao chép!' : 'Sao chép'}
                    >
                        Sao chép
